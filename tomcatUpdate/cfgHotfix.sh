...
currDir=`pwd`
#check BDNA version
echo -e "Step (1/6) check BDNA version."
...
echo -e "Step (2/6) get BDNA configuration."
...
echo -e "Step (3/6) unzip package tomcat 8.5.32 files to $BDNA_HOME."
...
echo -e "Step (4/6) update BDNA configuration."
...
echo -e "Step (5/6) update class files for bdna.jar and bdna_g.jar."
...
echo -e "Step (6/6) remove batik 1.5."
#rm batik* files in nih/Tomcat/apache-tomcat-8.5.32/lib
rm -rf $BDNA_HOME/nih/Tomcat/apache-tomcat-8.5.32/lib/batik*
